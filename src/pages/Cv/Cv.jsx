    ...
    <div id="cvContainer">
      ...
      <div id="columnRight">
        ...
        <div id="coordonnees">
          ...
          <div className="alignItemCoordonnees">
            <FaLinkedin />
            <a href={coordonnees.linkLinkedin} target="blank">
              mon linkedin
            </a>
          </div>
          <div className="alignItemCoordonnees">
            <FaGithub />
            <a href={coordonnees.linkGithub} target="blank">
              mon Github
            </a>
          </div>
          <div className="alignItemCoordonnees">
            <FaInternetExplorer />
            <a href={coordonnees.linkPorfolio} target="blank">
              mon Portfolio
            </a>
          </div>
        </div>
